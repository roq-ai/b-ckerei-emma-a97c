            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('bakery', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>bakery</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('bakery', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/bakeries/view/${record.bakery?.id}`}>
                          {record.bakery?.name}
                        </Link>
                      </Td>
                    )}
